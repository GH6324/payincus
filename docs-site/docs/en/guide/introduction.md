...
It is based on `qwer-xyz/incudal` and focuses on non-Docker production deployment, split user/admin frontends, payment callbacks, resource delivery, host Agent reporting and admin OTA updates.
